        ...
        <div class="content-wrapper">
            <div class="row">
                <div class="col-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <h2>Inserir nova certificació</h2>
                            <p> * Camps obligatoris </p>
                            <br>
                            <form class="forms-sample" method="POST" action="{{ route('backend.certificacions.store') }}" enctype="multipart/form-data" novalidate>
                                @csrf
                                @error('titol_esp')
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group">
                                                        <label>Imatge certificacions</label>
