        ...
        <div class="content-wrapper">
            <div class="row">
                <div class="col-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <h2>Inserir nova història</h2>
                            <p> * Camps obligatoris </p>
                            <br>
                            <form class="forms-sample" method="POST" action="{{ route('backend.histories.store') }}" enctype="multipart/form-data" novalidate>
                                @csrf
                                @error('titol_esp')
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="any" type="number" class="form-control @error('any') is-invalid @enderror" id="exampleInputEmail3" placeholder="Any" value="{{ old('any') }}">
                                </div>
                                <div class="form-group">
