        ...
        <div class="content-wrapper">
            <div class="row">
                <div class="col-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <h2>Inserir nou jugador</h2>
                            <p> * Camps obligatoris </p>
                            <br>
                            <form class="forms-sample" method="POST" action="{{ route('backend.equips.jugadors.store') }}" enctype="multipart/form-data" novalidate>
                                @csrf
                                @error('id_equip')
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="dorsal" type="text" class="form-control @error('dorsal') is-invalid @enderror" id="exampleInputEmail3" placeholder="Dorsal" value="{{ old('dorsal') }}">
                                </div>
                                <div class="form-group">
